...
function (SuperClass, BreaseEvent, VirtualEvents, Utils, Enum, Types, KeyActions, EventHandler, permissions, fileManager, AsyncProcess, tooltipDependency) {
    ...
    * Syntax:  
    * ["*"] all widgets and content allowed as parent  
    * ["system.brease.Content"] only allowed to be inserted on the content directly  
    * ["some/example/containerwidget1", "some/example/containerwidget2"] some widgets allowed as parent  
    */
    /**
    * @property {WidgetList} children=[]
    * Allowed children for this Widget.  
    * Syntax:  
    * [] no widgets allowed as children  
    * ["*"] all widgets allowed as children  
    * ["some/example/widget1", "some/example/widget2"] some widgets allowed as children  
    */
    /**
    ...
    */
    p.setEnable = function (value) {
        ...
        if (origin !== 'server' && origin !== 'action') {
